...
<CardGroup cols={2}>
  <Card title="Account Setup" icon="pen-to-square" href="/merchant-portal/account-setup">
    Learn MDX syntax and start writing your documentation.
  </Card>

  <Card title="Adding Your Charging Station" icon="palette" href="/essentials/settings">
    Make your docs match your brand perfectly.
  </Card>

  <Card title="Managing Chargers" icon="square-code" href="/essentials/code">
    Include syntax-highlighted code blocks.
  </Card>

  <Card title="Managing Charging Sessions" icon="code" href="/api-reference/introduction">
